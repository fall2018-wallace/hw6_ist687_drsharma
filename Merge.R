...
#Below line of codes are used to merge the data frames USArrests and arrests using merge command and storing the merged data frame into another variable merged_data
